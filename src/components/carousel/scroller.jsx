...
export const Scroller = ({
    ...
    return (
        <div className="relative isolate">
            <SpyWindow state={state} data={[
                { label: "prev", data: state.prev.get() },
                { label: "index", data: state.index.get() },
                { label: "next", data: state.next.get() },
                { label: "min", data: state.min.get() },
                { label: "max", data: state.max.get() }
            ]}/>
            <div
