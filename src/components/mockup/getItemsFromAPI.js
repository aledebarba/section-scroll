  ...
  return [
    {
      ...
      image: "JPEG/slide-0.jpg",
      heroImage: "JPEG/slide-0.jpg",
      callToAction: { text: "Call to Action", link: "https://www.google.com" },
      layout: "default",
    },
    {
      id: "item-2",
    ...
    },
    {
      ...
      icon: "fluent-emoji:avocado",
      image: "/JPEG/slide-3.jpg",
      heroImage: "JPEG/slide-0.jpg",
      callToAction: { text: "Call to Action", link: "https://www.google.com" },
      layout: "default",
    },
    ...
    },
    {
      ...
      icon: "fluent-emoji:bear",
      image: "/JPEG/slide-6.jpg",
      heroImage: "JPEG/slide-0.jpg",
      callToAction: { text: "Call to Action", link: "https://www.google.com" },
      layout: "default",
    },
    ...
    },
    {
      ...
      image: "/JPEG/slide-9.jpg",
      heroImage: "JPEG/slide-0.jpg",
      callToAction: { text: "Call to Action", link: "https://www.google.com" },
      layout: "default",
    }
  ].map( item => {
    const bgColor = `hsl(${Math.round(Math.random() * 360)}, 100%, 15%)`
    const bg = `radial-gradient(ellipse_at_center,_${bgColor}_35%,_rgba(0,0,0,0.15)_100%)`;
        return { ...item, background: bg } });
}
