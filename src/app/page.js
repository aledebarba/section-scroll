  ...
  const k2 = useCounter();
   ...
   return (
    <FullScreenScroll className="w-screen overflow-x-hidden" >
      <Section
        className="relative grid w-screen h-screen bg-slate-400 place-content-center"
      ...
      <Section
        ...
        snapconfig={{
          duration: 1.5,
          ease: "circ.*",
          Next: ()=><span className="absolute grid w-auto h-8 px-10 py-5 transform -translate-x-1/2 rounded-lg cursor-pointer left-1/2 place-content-center bottom-24 md:bottom-16 hover:bg-black">NEXT</span>,
      ...
      <Section
        ...
        >
        <div className="flex flex-col items-center px-10 py-5 border-4 border-yellow-500 border-dashed rounded-lg">
          <h1 className="mx-auto text-2xl text-black">WELLCOME TO SECTION</h1>
          <h1 className="mx-auto text-2xl font-bold text-indigo-900 drop-shadow-md shadow-black lg:text-8xl" >INDIGO</h1>
        </div>
        <Link
          to="section3"
          ease="power4.inOut"
          duration={0.3}
          className="grid px-4 py-2 mt-5 rounded-full cursor-pointer place-content-center hover:bg-yellow-500 hover:text-black"
          >
            Click here to scroll down straight to Section 3
        </Link>
